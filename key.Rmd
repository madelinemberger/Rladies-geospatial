...
Direct downloads: 
HI Statewide GIS Portal
- Watersheds: https://geoportal.hawaii.gov/search?groupIds=4ef473112ddd427d844394e44b62dba2
- Agriculture Lands: https://geoportal.hawaii.gov/datasets/342ee6c7547f45ddbfc07caf4ca2887d_19/explore?location=20.542715%2C-157.274800%2C7.41

Ocean Tipping Points PACIOOS:
- Presence / Absence of Invasive Algae Raster: https://www.pacioos.hawaii.edu/projects/oceantippingpoints/#data
...
# filter for large watersheds only, watersheds named Waimea

range(watersheds$st_areasha) # what is the range

large_watersheds <- watersheds %>% 
  filter(st_areasha > 9e07)
...
# challenge - filter for only the following crops: 
